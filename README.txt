...
'sphfract' is a much more complex scenario, with dozens of spheres in
a fractal pattern (see gen_fract.txt for details of how the scene
description was created). Examine sphfract.jpg to see the final image.
...
are used for the main table on the results page. The tests are:
  ...
  Test   Data File    Image Resolution     Oversampling
   ...
   2.    sphfract      Default 800x600      NONE
   3.    sphfract      1024 x 768           8X
...
while on a Windows system these would be:
  ...
  c-ray-f -i sphfract -o foo.ppm
  c-ray-mt -t 32 -i sphfract -o foo.ppm
  c-ray-f -s 1024x768 -r 8 -i sphfract -o foo.ppm
  c-ray-mt -t 32 -s 1024x768 -r 8 -i sphfract -o foo.ppm
